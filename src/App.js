...
function App() {
  async function fetchData() {
    ...
    const publicAssertionId = await DkgClient.assertion.getPublicAssertionId(
      content
    );
    console.log(
      "======================== PUBLIC ASSERTION ID (MERKLE ROOT) CALCULATED"
    );
    console.log(publicAssertionId);

    divider();

    const publicAssertionSize = await DkgClient.assertion.getSizeInBytes(
      content
    );
    ...
    const increaseAllowanceResult = await DkgClient.asset.increaseAllowance(
      bidSuggestion
    );
    ...
    const decreaseAllowanceResult = await DkgClient.asset.decreaseAllowance(
      bidSuggestion
    );
    ...
    const setAllowanceResult = await DkgClient.asset.setAllowance(
      bidSuggestion
    );
    ...
    const getLatestAssetResult = await DkgClient.asset.get(
      createAssetResult.UAL
    );
    ...
    let getLatestFinalizedAssetResult = await DkgClient.asset.get(
      createAssetResult.UAL,
      {
    ...
    getLatestFinalizedAssetResult = await DkgClient.asset.get(
      createAssetResult.UAL,
      {
        state: "LATEST_FINALIZED",
      }
    ...
    const getFirstStateByIndex = await DkgClient.asset.get(
      createAssetResult.UAL,
      {
        state: 0,
      }
    ...
    console.log(
      "======================== ASSET FIRST STATE (GET BY STATE INDEX) RESOLVED"
    );
    console.log(JSON.stringify(getFirstStateByIndex, null, 2));

    divider();

    const getSecondStateByIndex = await DkgClient.asset.get(
      createAssetResult.UAL,
      {
        state: 1,
      }
    ...
    console.log(
      "======================== ASSET SECOND STATE (GET BY STATE INDEX) RESOLVED"
    );
    console.log(JSON.stringify(getSecondStateByIndex, null, 2));

    divider();

    const getFirstStateByHash = await DkgClient.asset.get(
      createAssetResult.UAL,
      {
    ...
    console.log(
      "======================== ASSET FIRST STATE (GET BY STATE HASH) RESOLVED"
    );
    console.log(JSON.stringify(getFirstStateByHash, null, 2));

    divider();

    const getSecondStateByHash = await DkgClient.asset.get(
      createAssetResult.UAL,
      {
    ...
    console.log(
      "======================== ASSET SECOND STATE (GET BY STATE HASH) RESOLVED"
    );
